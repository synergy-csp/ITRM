...
namespace ITRM.Forms {
    ...
    public partial class RequestReasonEdit : Form<E_ITRM_RequestReasonEditEntity> {

        // properties
        TextBox RequestReason { get; set; }
TextArea Description { get; set; }
ComboBox RequestType { get; set; }


        // constructor
        public RequestReasonEdit(FormHttpParameters httpParameters, ITelemetryCollectorHolder telemetryCollectorHolder = null)
...
{ "tr-TR", "RequestReasonEdit" },
{ "en-US", "RequestReasonEdit" },
};
Name = "RequestReasonEdit";
FormId = "e8c39a35-6f34-4215-b636-13bc94787f1f";
...
"RequestReasonEdit.client.OnBeforeSave",
"RequestReasonEdit.server.OnBeforeSave",
"RequestReasonEdit.client.OnToolbarButtonClicked",
"RequestReasonEdit.server.OnToolbarButtonClicked",
}
}
},
};
...
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Talep Nedeni" },{ "en-US", "RequestReasonEdit" },}){
...
BaseComponent default_requestreasoneditComponent = new BaseComponent {
Id = "RequestReasonEdit",
Type = "Form",
ParentId = "",
...
AddToViewItems("default", default_requestreasoneditComponent);

BaseComponent default_section1Component = new BaseComponent {
Id = "Section1",
Type = "Section",
ParentId = "RequestReasonEdit",
DesignerProps = new DesignerProps {
AllowAutoClear = true,
Layout = new ContainerLayout {
Width = null,
...
RequestReason = new TextBox {
ControlId = "559b2375-a4e6-6f32-e95b-7430a7ceebd4",
Name = "RequestReason",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
ControlId = "92dbda88-1f89-d7b1-68a8-c1cb9d643fd4",
Name = "Description",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
ControlId = "966c0e78-9d5b-9304-7201-14f2fa7f4e2a",
Name = "RequestType",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
