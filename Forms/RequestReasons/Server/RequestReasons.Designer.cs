...
namespace ITRM.Forms {
    ...
    public partial class RequestReasons : Form<E_ITRM_RequestReasonsEntity> {

        // properties
        DataGrid RequestReasons_Grid { get; set; }


        // constructor
        public RequestReasons(FormHttpParameters httpParameters, ITelemetryCollectorHolder telemetryCollectorHolder = null)
...
{ "tr-TR", "RequestReasons" },
{ "en-US", "RequestReasons" },
};
Name = "RequestReasons";
FormId = "e9c5691b-12b7-4d3e-9a11-faa730c81089";
...
MethodName = "RequestReasons_OnMessageReceived",
Async = null
},
};
...
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Talep Nedenleri" },{ "en-US", "RequestReasons" },}){
...
BaseComponent default_requestreasonsComponent = new BaseComponent {
Id = "RequestReasons",
Type = "Form",
ParentId = "",
...
AddToViewItems("default", default_requestreasonsComponent);

BaseComponent default_row1Component = new BaseComponent {
Id = "Row1",
Type = "Section",
ParentId = "RequestReasons",
DesignerProps = new DesignerProps {
AllowAutoClear = true,
Layout = new ContainerLayout {
Width = null,
...
RequestReasons_Grid = new DataGrid {
ControlId = "0ad029e8-a99f-475d-b020-97aa539f3086",
Name = "RequestReasons_Grid",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
new EventItem {
Name = "OnActionButtonClick",
MethodName = "RequestReasons_Grid_OnActionButtonClick",
Async = null
},
},
Visible = true,
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "RequestReasons_Grid" },{ "en-US", "RequestReasons_Grid" },{ "ru-RU", "RequestReasons_Grid" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Controls.Add(RequestReasons_Grid);

BaseComponent default_requestreasons_gridComponent = new BaseComponent {
Id = "RequestReasons_Grid",
Type = "DataGrid",
ParentId = "Column1",
DesignerProps = new DesignerProps {
AllowAutoClear = true,
...
Properties = RequestReasons_Grid,
ViewProperties = "",
};

AddToViewItems("default", default_requestreasons_gridComponent);
